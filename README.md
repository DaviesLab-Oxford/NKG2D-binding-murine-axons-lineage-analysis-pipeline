...
We would like to acknowledge Dr Demetrio Labate for the creation of the Dimensionality Ratio method contained within the SomaExtration package that forms part of this analysis pipeline:
...
Note: The original 'Script_Gaussian.m' function has been re-written to allow batch processing of images for soma extraction  and renamed 'Matlab_Script_Guassian.m'.
